...
#the purpose of the code below is not to train the best model, but rather to show an example of how to use a model.
#ideally, we'll pre-train our model and save it as a pickled file, and then load it from file in order to make predictions. However given the specific nature of this application and needing a separate model for each combination of two users, we'll do our model training "live"...
# web_app/routes/stats_routes.py
