# Web_App/Twitoff/routes/stats_twitter_routes.py
...
def predict():
    ...
    # breakpoint()
    # inspect x and y values to make sure they are the best format for training
    # maybe need to impute?
    classifier = LogisticRegression() # for example
    classifier.fit(embeddings, labels)
    # TODO: make sure there is an even number of tweets between users
    #breakpoint()
